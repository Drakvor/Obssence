      ...
      children: [
        ...
        Container(
          child: Row(
            ...
            children: [
              Container(
                child: Text("갯수: " + selection.quantity.toString(), style: utils.resourceManager.textStyles.base10,),
              ),
              Container(
                child: Text("사이즈: " + selection.size, style: utils.resourceManager.textStyles.base10,),
              ),
            ],
          ),
        ),
